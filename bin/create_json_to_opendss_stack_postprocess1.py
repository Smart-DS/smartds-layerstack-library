...
#create_rnm_to_opendss_stack(os.path.join('..','..','dataset3', 'MixedHumid'), 'industrial')
    ...
    if not os.path.isdir(os.path.join('.','results_v3',region,'base','opendss')):
        os.makedirs(os.path.join('.','results_v3',region,'base','opendss'))
    if not os.path.isdir(os.path.join('.','results_v3',region,'base','json_opendss')):
        os.makedirs(os.path.join('.','results_v3',region,'base','json_opendss'))
    s.run_dir = 'run_dir'
    s.run()
